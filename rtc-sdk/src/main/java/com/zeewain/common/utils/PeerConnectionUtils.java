...
public class PeerConnectionUtils {
    ...
    private void createCamCapture(Context context) {
        ...
        for (String deviceName : deviceNames) {
            boolean needFrontFacing = "front".equals(mPreferCameraFace);
    ...
    @MainThread
    private void createVideoSource(Context context, int width, int height, int fps) {
        ...
        mCamCapture.startCapture(width, height, fps);
    }
    ...
    public VideoTrack createVideoTrack(Context context, String id, int width, int height, int fps) {
        Logger.d(TAG, "createVideoTrack()");
        mThreadChecker.checkIsOnValidThread();
        if (mVideoSource == null) {
            createVideoSource(context, width, height, fps);
        }
